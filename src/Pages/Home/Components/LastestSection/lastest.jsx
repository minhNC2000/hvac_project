...
const Lastest = () => {
  ...
  useEffect(() => {
    API.get().then(({ data }) => setNewblog(data)).finally(() => setLoading(false));
  }, []);
          ...
          <Grid container spacing={1}>
            <Grid sm={12} md={12} lg={12}>
              <div className="section-title">
                ...
                <p>
                  Sign up for the latest Automobile Industry information and
                  more. Duis aute
                  <br /> irure dolorin reprehenderits volupta velit dolore
                  fugiat.
                </p>
              </div>
            </Grid>
